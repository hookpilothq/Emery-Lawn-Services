...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Professional hardscaping and landscaping services. Call Emery Lawn Services at (908) 894-9903 for a free estimate." },
      { name: "twitter:description", content: "Professional hardscaping and landscaping services. Call Emery Lawn Services at (908) 894-9903 for a free estimate." },
